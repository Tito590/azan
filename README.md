...
## v3 — update visual
- `assets/argopuro-pouch-solid.png` adalah crop pouch Argopuro dengan background transparan tetapi label, tulisan, dan artwork tetap solid.
- Keranjang pada karakter menggunakan visual yang berisi buah kopi/cherries, bukan keranjang kosong/transparan.
- Setelah izin kamera diberikan, petani ditampilkan segera (tanpa jeda 0,9 detik).
- Karakter mendapat animasi napas, body sway, dan greeting-wave cycle sehingga sapaan terasa hidup.

### Tentang gerakan tangan
Asset petani yang dipakai adalah satu gambar raster. CSS dapat menganimasikan karakter dan gesture secara keseluruhan, tetapi tidak dapat memutar tulang tangan secara independen. Untuk gerakan tangan yang benar-benar artikulatif (siku/pergelangan bergerak sementara tubuh tetap), gunakan versi rigged/sprite atau video/WebM transparan. Struktur project sudah siap untuk mengganti asset tersebut tanpa mengubah alur QR/kamera.
